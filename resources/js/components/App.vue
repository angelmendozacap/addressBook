<template>
  <div class="h-screen bg-white">
    <div class="flex flex-col-reverse sm:flex-row flex-wrap">
      <div class="w-full sm:w-1/3 md:w-1/4 pl-6 bg-gray-200 sm:h-screen border-r-2 border-gray-400">
        <nav class="py-4">
          ...
          <p class="pt-12 text-gray-500 text-xs uppercase font-bold ">Crear</p>
          ...
          <router-link to="/contacts/create" class="text-sm flex items-center py-2 hover:text-blue-600">
            ...
            <span class="tracking-wide pl-3">Agregar Nuevo</span>
          </router-link>
          ...
          <router-link to="/contacts" class="text-sm flex items-center py-2 hover:text-blue-600">
            ...
            <span class="tracking-wide pl-3">Contactos</span>
          </router-link>
          <router-link to="/birthdays" class="text-sm flex items-center py-2 hover:text-blue-600">
            ...
            <span class="tracking-wide pl-3">Cumpleaños</span>
          </router-link>

          <p class="pt-12 text-gray-500 text-xs uppercase font-bold ">Configuraciones</p>

          <a href="#" @click.prevent="logout" class="text-sm flex items-center py-2 hover:text-blue-600">
            ...
            <span class="tracking-wide pl-3">Logout</span>
          </a>
        </nav>
      </div>
